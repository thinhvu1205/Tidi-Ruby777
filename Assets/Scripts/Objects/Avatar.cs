...
public class Avatar : MonoBehaviour
{
    ...
    public async void loadAvatar(int idAva, string fbName, string fbId, string name = "")
    {
        ...
        else
        {
            ...
            var avtLink = Globals.Config.avatar_fb == "" ? "https://graph.facebook.com/%fbID%/picture?type=square" : Globals.Config.avatar_fb;
    ...
    public async void loadAvatarAsync(int idAva, string fbName, string fbId = "")
    {
        ...
        else
        {
            ...
            Task<Sprite> test = Globals.Config.GetRemoteSprite(avtLink);
            if (this != null && test != null && image != null) image.sprite = await test;
            // image.sprite = await Globals.Config.GetRemoteSprite(avtLink);
        }
    }
