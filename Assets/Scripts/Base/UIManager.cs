...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] public Transform parentPopups, parentGame, parentPopupsInMain, parentBanner;
    ...
    public string _PusoyJackPot;


    public Sprite spAvatarMe;

    private IEnumerator GetClientIP()
    {
