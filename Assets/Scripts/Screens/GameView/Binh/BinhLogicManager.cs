...
public class BinhLogicManager : MonoBehaviour
{
    ...
    public bool checkThungPhaSanh(List<Card> listIn, int size = 5)
    {
        List<Card> list = new List<Card>(listIn);

        if (checkThung(list, size) && checkSanh(list, size))
            return true;

        return false;
    }

    public bool checkXam(List<Card> listIn)
    {
        List<Card> list = new List<Card>(listIn);
    ...
    public bool checkTuQuy(List<Card> listIn)
    {
        List<Card> list = new List<Card>(listIn);
    ...
    public bool checkCulu(List<Card> listIn)
    {
        List<Card> list = new List<Card>(listIn);

        if (!checkXam(list) || list.Count < 5)
            return false;
    ...
    public bool checkDoi(List<Card> listIn)
    {
        List<Card> list = new List<Card>(listIn);
    ...
    public bool checkThu(List<Card> listIn)
    {
        List<Card> list = new List<Card>(listIn);
        list.Sort((x, y) => x.N - y.N);
