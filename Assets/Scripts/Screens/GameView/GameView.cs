...
public class GameView : BaseView
{
    ...
    protected override void Start()
    {
        ...
        else if (Config.curGameId == (int)GAMEID.SLOT_JUICY_GARDEN)
        {
            soundBg = SOUND_SLOT.BG_JUICY_GARDEN;
        }
        else if (Config.curGameId == (int)GAMEID.SLOT_SIXIANG)
        {
            soundBg = SOUND_SLOT_BASE.BG_GAME;
        }
    ...
    protected virtual void updatePositionPlayerView()
    {
        ...
        if (Config.curGameId == (int)GAMEID.TONGITS || Config.curGameId == (int)GAMEID.TONGITS_OLD || Config.curGameId == (int)GAMEID.TONGITS_JOKER)
        {
            thisPlayer.playerView.setPosThanhBarThisPlayer();
            thisPlayer.updateItemVip(thisPlayer.vip, true);
        }
    }
