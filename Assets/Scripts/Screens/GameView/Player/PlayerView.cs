...
public class PlayerView : MonoBehaviour
{
    ...
    public void updateItemVip(int idVip, int vip, bool needChangePos)
    {
        // return;
        //idVip = 100;
        //vip = 10;
        ...
        if (vip >= 5 && idVip != 0)
        {
            ...
            else if (Globals.Config.curGameId == (int)Globals.GAMEID.TONGITS_OLD || Globals.Config.curGameId == (int)Globals.GAMEID.TONGITS_JOKER || Globals.Config.curGameId == (int)Globals.GAMEID.TONGITS)
            {
                vecPos.x = needChangePos ? 100 : -100;
                vecPos.y = needChangePos ? 100 : -20;
            }
            else
            {
                vecPos.y = -60;
    ...
    Sequence seqVib;
    public virtual void setTurn(bool isTurn, float _timeTurn = 0f, bool _isMe = false)
    {
        timeCounDown.DOKill();
