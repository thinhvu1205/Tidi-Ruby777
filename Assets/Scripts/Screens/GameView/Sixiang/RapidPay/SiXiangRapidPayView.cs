...
public class SiXiangRapidPayView : MonoBehaviour
{
    ...
    public Task Show(SiXiangView SiXiangView, List<JObject> initData = null)
    {
        ...
        lbWinAmount.text = Globals.Config.FormatNumber(winAmount);
        if (initData != null)
        {
    ...
    public async void setResult(JObject data)
    {
        ...
        if (itemPicked != 1) //ko pick phai end
        {
    ...
    private void showResult()
    {
        ...
        lbWinResult.setValue(winAmount, true, 2.0f, "", () =>
        {
            soundMoney.Stop();
