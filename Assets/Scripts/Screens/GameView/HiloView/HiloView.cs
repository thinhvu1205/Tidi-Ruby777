...
public class HiloView : GameView
{
    ...
    private List<List<int>> fakDataHIstory = new List<List<int>>();
    ...
    public void sendBetSicbo(string data)
    {
        ...
        {
            string msg = Globals.Config.getTextConfig("txt_max_bet");
        ...
        for (int i = 0; i < players.Count; i++)
        {
            ...
            if (player == thisPlayer)
            {
                ...
                if (playerV.agWin > 0)
                {
                    ...
                    nodeAniWinLose.transform.Find("ani_Win").GetComponent<SkeletonGraphic>().AnimationState.SetAnimation(0, "indo", false);
                ...
                else if (playerV.agLose < 0)
                {
                    ...
                    nodeAniWinLose.transform.Find("ani_Lose").GetComponent<SkeletonGraphic>().AnimationState.SetAnimation(0, "indo", false);
