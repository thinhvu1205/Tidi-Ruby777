...
public class BoxbetSicbo : MonoBehaviour
{
    ...
    private void setValueLabel()
    {
        ...
        for (int i = 0; i < dataClickBet.Count; i++)
        {
            ...
            totalBoxBet += (long)Mathf.Min((int)dataClick["value"], gameView.thisPlayer.ag - totalBoxBet - gameView.totalBet);
    ...
    public void onClickBet(int index, long value)
    {
        ...
        {
            listB[index] += (long)Mathf.Min(value, gameView.thisPlayer.ag - totalBoxBet - gameView.totalBet);
