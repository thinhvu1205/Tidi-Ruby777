...
public class SocketSend
{
    ...
    {
        Debug.Log("Send Select Game");
        if (Globals.Config.isSendingSelectGame == false)
        {
            var severIp = "";
            ...
            if (severIp != Globals.Config.curServerIp)
            {
                ...
                // test
                sendSelectG2(gameId); //test minefinding game
    ...
    public static void sendChatEmo(string nameSe, string nameRe, string type, bool ping = true)
    {
        JObject data = new JObject();
        data["evt"] = "chattable";
        data["Name"] = nameSe;
        ...
        data["T"] = "*f" + type;
        WebSocketManager.getInstance().sendDataGame(data.ToString(Newtonsoft.Json.Formatting.None), ping);
    }
    ...
    //====================End BINH======================
    //====================SABONG======================
    public static void SendBetSabong(int agBet, int betOptionId, bool needCheckAlive = true)
    {
        JObject data = new()
        {
            ["evt"] = "bm",
        ...
        WebSocketManager.getInstance().sendDataGame(data.ToString(Newtonsoft.Json.Formatting.None), needCheckAlive);
    }
    //====================END SABONG======================
    //====================LUCKY89======================
