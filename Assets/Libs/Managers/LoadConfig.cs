...
public class LoadConfig : MonoBehaviour
{
    ...
    JObject createBodyJsonNormal()
    {
        ...
        wWForm["bundleID"] = "tongits11.game.cocos"; //Globals.Config.package_name
        // wWForm["bundleID"] = "indo.test";
        wWForm["version"] = Globals.Config.versionGame + "";
        wWForm["operatorID"] = Globals.Config.OPERATOR + "";
        wWForm["publisher"] = "indo_ruby_test_100";
    ...
    void handleConfigInfo(string strData)
    {
        ...
        {
            Config.listGame = jConfig["listGame"] as JArray;
        }
        //array
        //JObject dataBlackjack = new JObject();
        //dataBlackjack["id"] = 9501;
        //dataBlackjack["ip"] = "8.213.193.230";
        //dataBlackjack["ip_dm"] = "app1.jakartagames.net";
        //dataBlackjack["agSvipMin"] = 25000;
        //dataBlackjack["v_tb"] = 2;
        //Globals.Config.listGame.Add(dataBlackjack);
        Debug.Log("=-=-=-=-=-=-=-=-=- list agam");
        Debug.Log(Globals.Config.listGame);
        if (Globals.Config.listGame.Count > 0)
        {
            JObject datGa = (JObject)Globals.Config.listGame[0];
            Debug.Log("curGameId=1=" + Globals.Config.curGameId);
            if (Globals.Config.curGameId == 0)
            {
                Globals.Config.curGameId = (int)datGa["id"];
                Debug.Log("curGameId=2=" + Globals.Config.curGameId);
            }


            //var dataTongit = new JObject(datGa);
            //dataTongit["id"] = (int)Globals.GAMEID.TONGITS;
            //dataTongit["ip_dm"] = "";
            //Globals.Config.listGame.Add(dataTongit);
